...
.method public final invoke()Lcom/adapty/internal/data/cloud/AnalyticsEventQueueDispatcher;
    ...
    invoke-virtual {v1, v5, v4, v3}, Lcom/adapty/internal/di/Dependencies;->resolve(Ljava/lang/String;Lm80/c;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/adapty/internal/data/cloud/HttpClient;

    .line 6
    const-class v5, Lcom/adapty/internal/data/cloud/MainRequestFactory;
    ...
    check-cast v5, Lcom/adapty/internal/data/cloud/MainRequestFactory;

    .line 7
    const-class v6, Lcom/adapty/internal/data/cloud/NetConfigManager;
    ...
    check-cast v6, Lcom/adapty/internal/data/cloud/NetConfigManager;
    ...
    invoke-virtual {v1, v10, v8, v3}, Lcom/adapty/internal/di/Dependencies;->resolve(Ljava/lang/String;Lm80/c;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .line 12
    invoke-direct/range {v0 .. v7}, Lcom/adapty/internal/data/cloud/AnalyticsEventQueueDispatcher;-><init>(Lcom/adapty/internal/data/cache/CacheRepository;Lcom/adapty/internal/data/cloud/HttpClient;Lcom/adapty/internal/data/cloud/MainRequestFactory;Lcom/adapty/internal/data/cloud/NetConfigManager;Lcom/adapty/internal/utils/LifecycleManager;Lb90/f;Lb90/f;)V
