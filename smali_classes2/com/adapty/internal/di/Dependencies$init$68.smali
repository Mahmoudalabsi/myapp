.class final Lcom/adapty/internal/di/Dependencies$init$68;
...
.method public constructor <init>(Lcom/adapty/models/AdaptyConfig;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/adapty/internal/di/Dependencies$init$68;->$config:Lcom/adapty/models/AdaptyConfig;
...
.method public final invoke()Lcom/adapty/internal/AdaptyInternal;
    ...
    check-cast v5, Lcom/adapty/internal/domain/PurchasesInteractor;

    .line 7
    const-class v6, Lcom/adapty/internal/domain/PaywallInteractor;
    ...
    check-cast v6, Lcom/adapty/internal/domain/PaywallInteractor;

    .line 8
    const-class v7, Lcom/adapty/internal/domain/OnboardingInteractor;
    ...
    check-cast v7, Lcom/adapty/internal/domain/OnboardingInteractor;

    .line 9
    const-class v8, Lcom/adapty/internal/domain/UserAcquisitionInteractor;
    ...
    check-cast v8, Lcom/adapty/internal/domain/UserAcquisitionInteractor;

    .line 10
    const-class v9, Lcom/adapty/internal/data/cloud/AnalyticsTracker;
    ...
    invoke-virtual {v1, v10, v9, v3}, Lcom/adapty/internal/di/Dependencies;->resolve(Ljava/lang/String;Lm80/c;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Lcom/adapty/internal/data/cloud/AnalyticsTracker;

    .line 11
    const-class v10, Lcom/adapty/internal/utils/LifecycleAwareRequestRunner;
    ...
    check-cast v10, Lcom/adapty/internal/utils/LifecycleAwareRequestRunner;

    .line 12
    const-class v11, Lcom/adapty/internal/utils/LifecycleManager;
    ...
    check-cast v11, Lcom/adapty/internal/utils/LifecycleManager;

    .line 13
    const-class v12, Lcom/adapty/internal/utils/AdaptyUiAccessor;
    ...
    check-cast v1, Lcom/adapty/internal/utils/AdaptyUiAccessor;

    .line 14
    iget-object v3, p0, Lcom/adapty/internal/di/Dependencies$init$68;->$config:Lcom/adapty/models/AdaptyConfig;

    invoke-virtual {v3}, Lcom/adapty/models/AdaptyConfig;->getObserverMode$adapty_release()Z

    move-result v3

    .line 15
    iget-object v12, p0, Lcom/adapty/internal/di/Dependencies$init$68;->$config:Lcom/adapty/models/AdaptyConfig;

    invoke-virtual {v12}, Lcom/adapty/models/AdaptyConfig;->getIpAddressCollectionDisabled$adapty_release()Z
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/adapty/internal/di/Dependencies$init$68;->invoke()Lcom/adapty/internal/AdaptyInternal;
